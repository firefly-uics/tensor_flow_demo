...
column_names = ['open', 'high', 'low', 'close', 'volume', 'ma5', 'ma10']
...
def load_data():
    ...
    y_train_col = x_train_col_index(columns, ['p_change'])[0]
...
def fit():
    ...
    logging.info("Testing set Mean Abs Error: ${:7.2f}, ${:7.2f}".format(mae, loss))
